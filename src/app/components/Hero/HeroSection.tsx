...
export const HeroSection = () => {
  return (
    <section className="w-full mb-16 relative min-h-[85vh]  h-fit flex  flex-col gap-10 sm:gap-8 items-center justify-center">
      <h1 className=" text-8xl xl:text-7xl lg:text-6xl sm:text-6xl text-center font-bold text-transparent bg-clip-text bg-gradient-to-b from-stone-600 from-40%  via-stone-700 via-60% to-stone-800 to-100%  ">
