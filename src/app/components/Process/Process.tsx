  ...
  return (
    <section className="my-24 sm:my-8 min-h-screen w-full flex flex-col items-center">
      ...
      <span className="absolute block lg:hidden left-[50%] h-full w-[1px] bg-gradient-to-b from-transparent via-purple to-transparent"></span>    {/* Divider*/}
        {/* First element*/}
        <div className=" w-full  h-2/6 bg-transparent flex lg:items-center lg:justify-center ">
            <div className="w-1/2 lg:w-2/3 sm:w-full h-full relative ">
                ...
                <div className=" rounded-md bg-white border border-solid border-purple w-[90%] lg:w-full h-full p-10 sm:p-6 flex flex-col justify-evenly gap-6 sm:gap-2   "> {/* CONTENT OF THE BOX*/}
                  <div className="flex flex-col gap-3 items-start ">  {/* Title Box*/}
                  <span className="relative w-10 h-10 border-purple rounded-md">
                  <Image src={apply} alt="apply" fill/>
                 </span> {/* Icon*/}
                  <h2 className="text-stone-800 font-semibold text-xl ">Client: Apply for Re-Design</h2>
                  </div>
                  <p className="  font-light text-lg xl:text-base ">First upload your current website and describe your business so designers get some key information about what direction to take.</p>
        ...
        {/* Second element*/}
        <div className="mt-[-100px] lg:mt-0  w-full  h-2/6 flex justify-end lg:items-center lg:justify-center">
            ...
            <span className="block lg:hidden absolute w-3 h-3 bg-gradient-to-b from-orange to-red-800  rounded-full left-0 top-[50%] -translate-y-[50%] -translate-x-[50%] z-40"></span>
              <span className="block lg:hidden absolute top-[50%] left-0 w-[10%] bg-gradient-to-l from-purple to-stone-500 h-[1px]"></span>
                  <div className=" rounded-md bg-white border border-solid border-purple w-[90%] lg:w-full h-full p-10 sm:p-6 flex flex-col justify-evenly gap-6 sm:gap-2   ">
                 ...
                 <p className=" text-lg xl:text-base  font-light">Designers and enthusiasts can find websites to work on to help out a business and expand their portfolio and skills.</p>
         ...
         {/* Third element*/}
         <div className="mt-[-100px]  lg:mt-0 w-full h-2/6 flex self-start lg:items-center lg:justify-center">
            <div className="w-1/2 lg:w-2/3 sm:w-full h-full relative">
            <span className="block lg:hidden absolute w-3 h-3 bg-gradient-to-b from-orange to-red-800  rounded-full -right-0 top-[50%] -translate-y-[50%] translate-x-[50%] z-40"></span>
                <span className="block lg:hidden absolute top-[50%] right-0 w-[10%] bg-gradient-to-l from-purple to-stone-500 h-[1px]"></span>
                <div className=" rounded-md bg-white border border-solid border-purple w-[90%] lg:w-full h-full p-10 sm:p-6 flex flex-col justify-evenly gap-6 sm:gap-2  "> {/* CONTENT OF THE BOX*/}
                <div className="flex flex-col gap-3 items-start ">  {/* Title Box*/}
                  ...
                  <p className=" text-lg xl:text-base   font-light">Once a designer decided to work on your website you can keep the communication going via chat inside the app and provide valuable input.</p>
                </div>
            </div>
        </div>
      </div>
